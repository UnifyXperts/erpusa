    ...
    refresh: function(frm) {
        if (frm.doc.email_queue) {
            if (frm.doc.stripe_subscription_id) {
                displayIntro(frm.doc.stripe_subscription_status)
            }
            else {
                frappe.call({
                    ...
                    callback: function (r) {
                        ...
                        displayIntro("Email " + r.message.status, additional_info);
        ...
        function displayIntro(stripe_subscription_status, additional_info="") {
            frm.set_intro(__(
